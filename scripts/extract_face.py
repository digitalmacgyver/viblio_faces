...
cmd = '/viblio/bin/viblio_video_analyzer -f %s --analyzers FaceAnalysis --face_detector_cascade_file /viblio/bin/lbpcascade_frontalface.xml --eye_detector_cascade_file haarcascade_eye_tree_eyeglasses.xml --face_thumbnail_path %s' % ( video_file, work_dir )
